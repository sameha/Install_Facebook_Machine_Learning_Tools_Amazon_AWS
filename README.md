...
sudo cp cudnn/lib64/*.so* /usr/local/cuda/lib64
...
unzip -j ~/datasets_zip/PASCAL_VOC.zip
unzip -j ~/datasets_zip/ILSVRC2014.zip
unzip -j ~/datasets_zip/instances_train-val2014.zip
...
sudo make install
export LD_LIBRARY_PATH=/home/ubuntu/torch/install/lib:/usr/local/cuda/lib64/:/usr/local/lib
NCCL_DEBUG=INFO ./build/test/single/all_reduce_test 10000000
```
